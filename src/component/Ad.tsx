...
export default function Ad() {
  return (
    <div className='p-10 md:p-20'>
      <div
        className='bg-[#111111] rounded-2xl p-6 md:p-12 flex flex-col items-center justify-center gap-4 text-center 
      ...
      >
        ...
        <button className='bg-yellow-400 text-black rounded-2xl p-4 font-medium' type='button'>
          Get Funded
        </button>
      </div>
    </div>
